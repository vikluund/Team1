<template>
  <div id="card-container">
    <div class="title-section">
      <h2 class="top-title">Our top activities</h2>
      ...
      <div class="row g-0">
        ...
        <div class="col-md-6">
          <div class="card-body" style="text-align: left">
            <h3 class="card-title">Icelandic horse tour</h3>
            <div class="line"></div>
            <p class="card-text">
              Enjoy riding the Icelandic horse in private through stunning nature and relax in the
              comfort of our exclusive facilities. Choose from unique adventures through the
              highlands on the oldest trails in Iceland or experience.
            </p>
    ...
    <div class="card mb-4 border-0" style="max-width: 100%" dir="rtl">
      <div class="row g-0">
        <div class="col-md-6">
          <img src="../assets/img/MicrosoftTeams-image (14).png" class="img-fluid" alt="..." />
        </div>
        <div class="col-md-6">
          <div class="card-body" style="text-align: left">
            <!-- <div class="content1"> -->
            <h3 class="card-title">Experience whale shark</h3>
            <div class="line2"></div>
            <p class="card-text">
    ...
    <div class="card mb-4 border-0" style="max-width: 100%">
      <div class="row g-0">
        ...
        <div class="col-md-6">
          <div class="card-body" style="text-align: left">
            <h3 class="card-title">HIT THE TRAILS</h3>
            <div class="line"></div>
            <p class="card-text">
              This is a wider card with supporting text below as a natural lead-in to additional
              content. This content is a little bit longer. This is a wider card with supporting
